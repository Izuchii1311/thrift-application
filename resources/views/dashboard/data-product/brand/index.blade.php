...
{{-- @section('title', $menu_path ? $menu_path->menu_name : 'Brand') --}}
@section('title', 'Brand')
@section('brand', 'here')
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            @if ($menu_access['can_create'])
                                ...
                                <i class="ki-outline ki-plus fs-2"></i>Tambah Brand Baru</button>
                            @endif
                        </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h2 class="fw-bold">Export Brand</h2>
                                        ...
                                        <form id="form-data" class="form" action="">
                                            ...
                                            <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="form_modal_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#form_modal_header" data-kt-scroll-wrappers="#form_modal_scroll" data-kt-scroll-offset="300px" >
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="text" name="brand_name" id="brand_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Nama Brand"/>
                                                </div>
                                            </div>
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'brand_name',       orderable: true },
                ],
                language: {
        ...
        function tambahData() {
            $('#form-data').attr('action', '{{ route("brand.store") }}');

            $('#form-data')[0].reset();
            $('#form-data select').val(null).trigger("change");

            $('#form_modal_title').text('Form Tambah Brand Baru');
            $('#brand_name').val("");
        ...
        function editData(slug) {
            $('#form-data').attr('action', "{{ url('brand/update') }}" + "/" + slug);

            $('#form_modal_title').text('Edit Data Brand');
            showLoading();

            $.ajax({
                url: "{{ url('brand/detail/json') }}" + "/" + slug,
                type: 'POST',
                ...
                error: function(result) {
                    alertResultError(result, "Error, Data Brand gagal didapatkan.");
                }
            });
        }
