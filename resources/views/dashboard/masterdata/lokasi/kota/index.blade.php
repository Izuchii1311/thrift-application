...
{{-- @section('title', $menu_path ? $menu_path->menu_name : 'Masterdata Kota') --}}
@section('title', 'Masterdata Kota')
@section('masterdata-kota', 'here')
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
                        <thead>
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                <th>No</th>
                                <th class="text-center">Kode / Nama Provinsi</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                ajax: {
                    url: '{{ route("masterdata-kota.indexJson") }}',
                    type: 'POST',
                    data: function (d) {
                        d._token = "{{ csrf_token() }}";
                        d.search = $('#search').val();
                ...
                columns: [
                    ...
                    { data: 'provinsi_info',    orderable: true, className: 'text-center' },
                    { data: 'id',               orderable: true, className: 'text-center' },
                    { data: 'nama_kota',        orderable: true },
                ],
                language: {
