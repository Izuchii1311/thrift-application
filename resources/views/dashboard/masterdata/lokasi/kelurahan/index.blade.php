...
{{-- @section('title', $menu_path ? $menu_path->menu_name : 'Masterdata Kelurahan') --}}
@section('title', 'Masterdata Kelurahan')
@section('masterdata-kelurahan', 'here')
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
                        <thead>
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                <th>No</th>
                                <th class="text-center">Kode / Nama Kecamatan</th>
                                <th class="text-center">Kode Kelurahan</th>
                                <th class="min-w-125px">Nama Kelurahan</th>
                            </tr>
                        </thead>
                    </table>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                ajax: {
                    url: '{{ route("masterdata-kelurahan.indexJson") }}',
                    type: 'POST',
                    data: function (d) {
                        d._token = "{{ csrf_token() }}";
                        d.search = $('#search').val();
                ...
                columns: [
                    ...
                    { data: 'kecamatan_info',   orderable: true, className: 'text-center' },
                    { data: 'id',               orderable: true, className: 'text-center' },
                    { data: 'nama_kelurahan',   orderable: true },
                ],
                language: {
