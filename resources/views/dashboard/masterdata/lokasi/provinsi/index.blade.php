...
{{-- @section('title', $menu_path ? $menu_path->menu_name : 'Masterdata Provinsi') --}}
@section('title', 'Masterdata Provinsi')
@section('masterdata-provinsi', 'here')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                ajax: {
                    url: '{{ route("masterdata-provinsi.indexJson") }}',
                    type: 'POST',
                    data: function (d) {
                        d._token = "{{ csrf_token() }}";
                        d.search = $('#search').val();
                ...
                columns: [
                    ...
                    { data: 'nama_provinsi',    orderable: true },
                ],
                language: {
